...
<html>
	...
	<body>
		...
		<div id="page-body" role="main">
			<h1><g:meta name="app.name"/> (Annotation Framework Grails Plugin)</h1>
			...
			<h2>About</h2>
			<blockquote>
			<font style="font-weight:bold;"><g:meta name="app.name"/></font> Grails Plugin is
			part of the <a href="https://github.com/annotationframework">Annotation Framework</a>.<br/> 
			The Plugin has been originally coded by <a href="https://paolociccarese.info">Dr. Paolo Ciccarese</a>.<br/>
